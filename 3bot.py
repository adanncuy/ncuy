...
adanncuy.login(token='EuwatVsegOPQ4p4ep1Uf.zsjptOGse28bSLj1PuTA7W.XOwbmgOhWPFKePe8O1zF9lQFj5coYWYkCyoftVnIqhE=')
...
KAC=[cl,ghost,adanncuy]
mid = cl.getProfile().mid
Emid = ghost.getProfile().mid
Fmid = adanncuy.getProfile().mid
Bots=[mid,Emid,Fmid,"u3a3d2af88f1113cd00e7934f862af688"]
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                if wait['likeOn'] == True:
                     ...
                     adanncuy.like(url[25:58], url[66:], likeType=1002)
		...
		cl.sendText(msg.to,"Itu Owner Saya (^_^)")
                ...
                admin2 = "u3a3d2af88f1113cd00e7934f862af688"
                admin3 = "u3a3d2af88f1113cd00e7934f862af688"
                msg.contentMetadata = {'mid': ar}
...
#BATASSSSS
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                cl.sendText(msg.to,"adanncuy1 Hadiir  \(ˆ▿ˆ)/")
