...
adanncuy.login(token='EuOA9sDYBinaNbluGhU8.oJ0Q/i8re80a55npHIR2Ia.ZqqqeZHEvSQ9KoNNgBtaIvktfOODztnVHqWjQKl8xFg=')
...
╚═════════════════════
ลิ้ง:  http://line.me/ti/p/adanncuy
──┅═✥===========✥═┅──
"""
helpMessage2 ="""
╔═════════════════════
...
Bots = ["",mid]
self = ["",mid]
admin = "u3a3d2af88f1113cd00e7934f862af688"
admsa = "u3a3d2af88f1113cd00e7934f862af688"
owner = "u3a3d2af88f1113cd00e7934f862af688"
adminMID = "u3a3d2af88f1113cd00e7934f862af688"
Creator="u3a3d2af88f1113cd00e7934f862af688"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
...
def restart_program():
    ...
    os.exeadanncuy(python, python, * sys.argv)
...
def _images_get_next_item(s):
    ...
    if start_line == -1:    #If no links are found then give an error!
        ...
        start_line = s.find('"adanncuyass="rg_meta"')
...
def upload_tempimage(adanncuyient):
    '''
    ...
    image = adanncuyient.upload_from_path(image_path, config=config, anon=False)
    print("Done")
    print()
...
def sendMessage(self, messageObject):
        return self.Talk.adanncuyient.sendMessage(0,messageObject)
...
def sendText(self, Tomid, text):
        ...
        return self.Talk.adanncuyient.sendMessage(0, msg)

def sendImage(self, to_, path):
    M = Message(to=to_, text=None, contentType = 1)
    M.contentMetadata = None
    M.contentPreview = None
    M2 = self._adanncuyient.sendMessage(0,M)
    M_id = M2.id
    files = {
       'file': open(path, 'rb'),
    }
...
def sendImage2(self, to_, path):
    ...
    M.contentMetadata = None
    M.contentPreview = None
    M_id = self._adanncuyient.sendMessage(M).id
    files = {
       'file': open(path, 'rb'),
    }
    params = {
    ...
    r = adanncuy.post_content('https://os.line.naver.jp/talk/m/upload.nhn', data=data, files=files)
    if r.status_code != 201:
       raise Exception('Upload image failure.')
    return True
        ...
        if op.type == 5:
            if wait["autoAdd"] == True:
                ...
                if (wait["message"] in [""," ","\n",None]):
                    ...
                    adanncuy.sendText(op.param1,str(wait["message"]))
                                ...
                                try:
                                    ...
                                    try:
                                        ...
                                        try:
                                            ...
                                            pass
                                        adanncuy.sendText(op.param1,"Group Name Lock")
        ...
        if op.type == 13:
                if op.param3 in mid:
                    if op.param2 in mid:
                        ...
                        adanncuy.updateGroup(G)
                        Ticket = adanncuy.reissueGroupTicket(op.param1)
                        adanncuy.acceptGroupInvitationByTicket(op.param1,Ticket)
...
#===========================================
            ...
            if mid in op.param3:
                ...
                if wait["autoJoin"] == True:
                    if wait["autoCancel"]["on"] == True:
                        ...
                        adanncuy.sendText(op.param1, "Your invitation was deadanncuyined\n\n[SELF BOT\n[By.☬adanncuy☬]]\n\nhttp://line.me/ti/p/adanncuy")
                    else:
                        adanncuy.acceptGroupInvitation(op.param1)
                        adanncuy.sendText(op.param1, "Your invitation was deadanncuyined\n\n[SEL FBOT\n[By.☬adanncuy☬]]\n\nhttp://line.me/ti/p/adanncuy")
                ...
                if matched_list == []:
                    ...
                    adanncuy.cancelGroupInvitation(op.param1, matched_list)
                ...
                if mid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("adanncuyient Kick regulation or Because it does not exist in the group、\n["+op.param1+"]\nの\n["+op.param2+"]\nを蹴る事ができませんでした。\nブラックリストに追加します。")
                    ...
                    ki1.updateGroup(G)
                    Ti = ki1.reissueGroupTicket(op.param1)
                    adanncuy.acceptGroupInvitationByTicket(op.param1,Ti)
                    time.sleep(0.01)
                    ...
                    X = adanncuy.getGroup(op.param1)
                    X.preventJoinByTicket = True
                    adanncuy.updateGroup(X)
                    Ti = adanncuy.reissueGroupTicket(op.param1)                    
                    if op.param2 in wait["blacklist"]:
                        pass
                    if op.param2 in wait["whitelist"]:
                        pass
                ...
                if Amid1 in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("adanncuyient が蹴り規制orグループに存在しない為、\n["+op.param1+"]\nの\n["+op.param2+"]\nBecause the adanncuyient does not exist in the kick regulation or group.\nAdd it to the blacklist.")
                        if op.param2 in wait["blacklist"]:
                            pass
                        if op.param2 in wait["whitelist"]:
                            pass
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.from_ == mid:
                    if "join:" in msg.text:
                        ...
                        try:
                            adanncuy.acceptGroupInvitationByTicket(list_[1],list_[2])
                            G = adanncuy.getGroup(list_[1])
                            G.preventJoinByTicket = True
                            adanncuy.updateGroup(G)
                        except:
            ...
            if msg.toType == 1:
                if wait["leaveRoom"] == True:
                    adanncuy.leaveRoom(msg.to)
            if msg.contentType == 16:
                url = msg.contentMetadata["postEndUrl"]
                adanncuy.like(url[25:58], url[66:], likeType=1001)
                    ...
                    if msg.text is not None:
                        ...
                        if data['status'] == 200:
                            if data['result']['result'] == 100:
                                adanncuy.sendText(msg.to, "[ChatBOT] " + data['result']['response'].encode('utf-8'))                    
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                    if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        adanncuy.sendText(msg.to,"already")
                        wait["wblack"] = False
                    else:
                        wait["commentBlack"][msg.contentMetadata["mid"]] = True
                        wait["wblack"] = False
                        adanncuy.sendText(msg.to,"decided not to comment")

               elif wait["dblack"] == True:
                   if msg.contentMetadata["mid"] in wait["commentBlack"]:
                        del wait["commentBlack"][msg.contentMetadata["mid"]]
                        adanncuy.sendText(msg.to,"Done deleted")
                        
                        wait["dblack"] = False

                   else:
                        wait["dblack"] = False
                        adanncuy.sendText(msg.to,"It is not in the black list")
                        
               elif wait["wblacklist"] == True:
                   if msg.contentMetadata["mid"] in wait["blacklist"]:
                        adanncuy.sendText(msg.to,"Done already")

                        wait["wblacklist"] = False
                   else:
                        wait["blacklist"][msg.contentMetadata["mid"]] = True
                        wait["wblacklist"] = False
                        adanncuy.sendText(msg.to,"Done done aded")
                ...
                if wait["lang"] == "JP":
                    ...
                    adanncuy.sendText(msg.to,helpt)
            elif msg.text in ["Help2"]:
                print "\nHelp pick up..."
                if wait["lang"] == "JP":
                    adanncuy.sendText(msg.to, helpMessage2 + "")
                else:
                    adanncuy.sendText(msg.to,helpt)
            elif msg.text in ["Help3"]:
                print "\nHelp pick up..."
                if wait["lang"] == "JP":
                    adanncuy.sendText(msg.to, helpMessage3 + "")
                else:
                    adanncuy.sendText(msg.to,helpt)
                    adanncuy.sendText(msg.to,helpt)
            elif ("Gn:" in msg.text):
                ...
                klist=[ki7,ki6,ki5,ki1,adanncuy]
                kicker = random.choice(klist)
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                if wait["winvite"] == True:
                     if msg.from_ == admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 adanncuy.sendText(msg.to,"-> " + _name + " was here")
                                 break
                             elif invite in wait["blacklist"]:
                                 adanncuy.sendText(msg.to,"Sorry, " + _name + " On Blacklist")
                                 adanncuy.sendText(msg.to,"Call my daddy to use command !, \n➡Unban: " + invite)
                                 break                             
                             else:
                         ...
                         if targets == []:
                             ...
                             for target in targets:
                                 try:
                                     ...
                                     adanncuy.sendText(msg.to,"Done Invite : \n➡" + _name)
                                     wait["winvite"] = False
                                     break
                                 except:
                                     try:
                                         ...
                                         adanncuy.sendText(msg.to,"Negative, Error detected")
                                         wait["winvite"] = False
                                         break
            if msg.contentType == 13:
            ...
            if msg.contentType == 13:
                ...
                if msg.toType == 2:
                   ...
                   try:
                       if len(query) == 3:
                           ...
                           isi = yt(query[1])
                           adanncuy.sendText(msg.to, isi[0])
                   except Exception as e:
                ...
                try:
                    ...
                    results = soup.find(attrs={'adanncuyass':'yt-uix-tile-link'})
                ...
                if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            f=codecs.open('st2__b.json','w','utf-8')
                            json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                            adanncuy.sendText(msg.to,"Done Banned")
                ...
                if msg.from_ in admin:
                    ...
                    for target in targets:
                        try:
                            ...
                            f=codecs.open('st2__b.json','w','utf-8')
                            json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                            adanncuy.sendText(msg.to,"Done Unbanned")
                ...
                if msg.from_ in admin:
                    ...
                    if cmd == "on":
                        if mimic["status"] == False:
                            mimic["status"] = True
                            adanncuy.sendText(msg.to,"Mimic on\n\nเปิดการเลียนเเบบ")
                        else:
                            adanncuy.sendText(msg.to,"Mimic already on\n\nเปิดการเลียนเเบบ")
                    elif cmd == "off":
                        if mimic["status"] == True:
                            mimic["status"] = False
                            adanncuy.sendText(msg.to,"Mimic off\n\nปิดการเลียนเเบบ")
                        else:
                            adanncuy.sendText(msg.to,"Mimic already off\n\nปิดการเลียนเเบบ")
                    elif "add:" in cmd:
                        ...
                        if targets == []:
                            adanncuy.sendText(msg.to,"No targets\n\nเกิดผิดพลาด")
                        else:
                            for target in targets:
                                try:
                                    mimic["target"][target] = True
                                    adanncuy.sendText(msg.to,"Success added target")
                                    adanncuy.sendMessageWithMention(msg.to,target)
                                    break
                                except:
                                    adanncuy.sendText(msg.to,"โปรเเกรมเลียนเเบบทำงาน")
                                    break
                    elif "del:" in cmd:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    adanncuy.sendText(msg.to,"Success deleted target")
                                    adanncuy.sendMessageWithMention(msg.to,target)
                                    break
                                except:
                                    adanncuy.sendText(msg.to,"คุณลบการเลียนเเบบผู้ใช้นี้")
                                    break
                    elif cmd == "list":
                        if mimic["target"] == {}:
                            adanncuy.sendText(msg.to,"No target")
                        else:
                            lst = "<<List Target>>"
                            ...
                            for a in mimic["target"]:
                                if mimic["target"][a] == True:
                                    ...
                                    stat = "Off"
                                lst += "\n-> " + adanncuy.getContact(a).displayName + " | " + stat
                            adanncuy.sendText(msg.to,lst + "\nTotal: " + total)
...
#----------------------------------------------------------------------------
                ...
                adanncuy.sendMessage(msg)
                adanncuy.sendText(msg.to,"Add Line http://line.me/ti/p/adanncuy")
                adanncuy.sendText(msg.to,"👆 สนใจ บอท ทักมาคุย กันได้นะครับ 👆")
#=========================================
...
#====================================================
            ...
            #VPS STUFF - VPS NEEDED TO RUN THIS COMMAND :)
                 ...
                 if msg.from_ in admin:
                     ...
                     adanncuy.sendText(msg.to, botKernel)
                     print "[Command]Kernel executed"
                 else:
                     adanncuy.sendText(msg.to,"Command denied.")
                     adanncuy.sendText(msg.to,"Admin permission required.")
                ...
                try:
                    ...
                    adanncuy.sendMessage(M)
                    adanncuy.sendText(msg.to,"old user")
				...
				adanncuy.sendText(msg.to, "Let's see who lazy to type")
				try:
                ...
                g = ""
                for i in gid:
                    g += "[%s]:%s\n" % (adanncuy.getGroup(i).name,i)
                adanncuy.sendText(msg.to,g)
...
#==================================================
                ...
                a = adanncuy.getGroupIdsJoined()
                for manusia in a:
                    adanncuy.sendText(manusia, (bctxt))
            elif msg.text.lower() == 'bann':
                blockedlist = adanncuy.getBlockedContactIds()
                adanncuy.sendText(msg.to, "Please wait...")
                kontak = adanncuy.getContacts(blockedlist)
                num=1
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    ki.updateProfile(profile)
                        ...
                        G = adanncuy.getGroup(msg.to)
                        ginfo = adanncuy.getGroup(msg.to)
                        G.preventJoinByTicket = False
                        adanncuy.updateGroup(G)
                        invsend = 0
                        Ticket = adanncuy.reissueGroupTicket(msg.to)
                        ...
                        ki1.sendText(msg.to,"[SELF BOT\ทBy:☬adanncuy☬ ]")
                        ki2.sendText(msg.to,"[Do not think  will try.]")
                        ki3.sendText(msg.to,"[ By: ☬adanncuy☬ ]")
                ...
                adanncuy.sendText(msg.to,"""[SELF BOT]\n[By:☬adanncuy☬]")
คำสั่งบอท siri
...
#==================================================
                ...
                if msg.from_ in admin:
                 wait["winvite"] = True
                 adanncuy.sendText(msg.to,"โปรดส่ง คท ด้วย")
                ...
                if msg.from_ in admin:
                 wait["winvite"] = False
                 adanncuy.sendText(msg.to,"ปิดการเชิญ แล้ว.")
                 ...
                 ki2.sendText(msg.to,"send contact")
                   ...
                   for target in targets:
                       try:
                           ...
                           adanncuy.inviteIntoGroup(msg.to,[target])
                           adanncuy.cancelGroupInvitation(msg.to,[target])
                       except:
                           adanncuy.sendText(msg.to,"Error")
            
            elif '123zzz' in msg.text.lower():
                    key = msg.text[-33:]
                    adanncuy.findAndAddContactsByMid(key)
                    adanncuy.inviteIntoGroup(msg.to, [key])
                    contact = adanncuy.getContact(key)
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            adanncuy.sendText(msg.to,"No one is inviting。")
                        else:
                            adanncuy.sendText(msg.to,"Sorry, nobody absent")
                else:
                    if wait["lang"] == "JP":
                ...
                if msg.toType == 2:
                    ...
                    adanncuy.updateGroup(X)
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"อนุญาติ ให้มีการเชิญ\nด้วยลิ้งแล้ว👌")
                    else:
                        adanncuy.sendText(msg.to,"already open")
                else:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Can not be used outside the group")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    adanncuy.updateGroup(X)
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"ปิดการเชิญ\nด้วยลิ้งแล้ว👌")
                    else:
                        adanncuy.sendText(msg.to,"already adanncuyose")
                else:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Can not be used outside the group")
                    else:
				...
				msg.contentMetadata = {'mid': mid}
				adanncuy.sendMessage(msg)
				adanncuy.sendText(msg.to,"[SELFBOT\nBy:☬adanncuy☬]")
            elif "ไอดี" == msg.text:
                key = msg.to
                adanncuy.sendText(msg.to, key)

            elif ("Hack " in msg.text):
                   key = eval(msg.contentMetadata["MENTION"])
                   key1 = key["MENTIONEES"][0]["M"]
                   mi = adanncuy.getContact(key1)
                   adanncuy.sendText(msg.to,"Mid:" + key1)
 ...
 #               adanncuy.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿[{PHET HACK BOT}] 􀜁􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 #\n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
...
#""")
                ...
                if msg.toType == 2:
                    ...
                    for _mid in gMembMids:
                        adanncuy.cancelGroupInvitation(msg.to,[_mid])
                    adanncuy.sendText(msg.to,"I pretended to cancel and canceled(๑و•̀ω•́)و")
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
									...
									f=codecs.open('st2__b.json','w','utf-8')
									json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
									adanncuy.sendText(msg.to,"Target Locked")
                                except:
                                    adanncuy.sendText(msg.to,"Error")
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
									...
									f=codecs.open('st2__b.json','w','utf-8')
									json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
									adanncuy.sendText(msg.to,"Target Unlocked")
                                except:
                                    adanncuy.sendText(msg.to,"Error")

            elif "Mid" == msg.text:
                adanncuy.sendText(msg.to,mid)			
                    ...
                    if wait["lang"] == "JP":
                        ...
                        if ginfo.preventJoinByTicket == True:
                          u = "[ปิด]"
                            ...
                            u = "[เปิด]"
                        adanncuy.sendText(msg.to,"[ชื่อของกลุ่ม]:\n" + str(ginfo.name) + "\n[Gid]:\n" + msg.to + "\n[ผู้สร้างกลุ่ม:]\n" + gCreator + "\n[ลิ้งค์รูปกลุ่ม]:\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus + "\n[จำนวนสมาชิก]:" + str(len(ginfo.members)) + "คน\n[จำนวนค้างเชิญ]:" + sinvitee + "คน\n[สถานะลิ้งค์]:" + u + "URL\n[By: ☬adanncuy☬]")
                    else:
                        adanncuy.sendText(msg.to,"Nama Gourp:\n" + str(ginfo.name) + "\nGid:\n" + msg.to + "\nCreator:\n" + gCreator + "\nProfile:\nhttp://dl.profile.line.naver.jp/" + ginfo.pictureStatus)
                else:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Can not be used outside the group")
                    else:
                ...
                if wait["protectionOn"] == True:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Already on\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        adanncuy.sendText(msg.to,"Protection On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                ...
                if wait["qr"] == False:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Already off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        adanncuy.sendText(msg.to,"Protection QR PRO Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    wait["qr"] = False
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Protection QR PRO Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["qr"] == True:
                    if wait["lang"] == "JP":
                        ...
                        adanncuy.sendText(msg.to,"Protection QR PRO On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    wait["qr"] = True
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Protection QR PRO On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["protectionOn"] == False:
                    if wait["lang"] == "JP":
                        ...
                        adanncuy.sendText(msg.to,"Protection Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                ...
                if msg.to in wait['pname']:
                    adanncuy.sendText(msg.to,"ล็อคชื่อ สำเร็จ.👌..")
                else:
                    adanncuy.sendText(msg.to,"bone..")
                    wait['pname'][msg.to] = True
                    wait['pro_name'][msg.to] = adanncuy.getGroup(msg.to).name
            elif "ปิด ล็อคชื่อ" in msg.text:
                if msg.to in wait['pname']:
                    adanncuy.sendText(msg.to,"ปิด ล็อคชื่อแล้ว.👌.")
				...
				gid = msg.to
				autocancel[gid] = "poni"
				adanncuy.sendText(msg.to,"ปิดการเชิญเข้ากลุ่ม\nของสมาชิกแล้ว.👌.")
            elif "เปิด เชิญ" == msg.text:
				try:
					del autocancel[msg.to]
					adanncuy.sendText(msg.to,"เปิด ให้สมาชิกทุกคน\nสามรถเชิญเพื่อนได้.👌.")
				except:
					pass
            elif "Cn: " in msg.text:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    adanncuy.sendText(msg.to,"Name " + string + " Done Bosqu")
            elif msg.text in ["invite:on"]:
                if msg.from_ in admin:
                 wait["winvite"] = True
                ...
                key = eval(msg.contentMetadata["MENTION"])
                key1 = key["MENTIONEES"][0]["M"]
                adanncuy.sendText(msg.to,"Mc: " + key1)
            elif "Mc: " in msg.text:
                ...
                if wait["contact"] == True:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Sudah on Bosqu")
                    else:
                        adanncuy.sendText(msg.to,"Ok Bosqu")
                else:
                    wait["contact"] = True
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Sudah on Bosqu")
                ...
                if wait["contact"] == False:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Sudah off Bosqu")
                    else:
                        adanncuy.sendText(msg.to,"Ok Bosqu ")
                else:
                    wait["contact"] = False
                ...
                try:
                    ...
                    if strnum == "off":
                        ...
                        if wait["lang"] == "JP":
                            adanncuy.sendText(msg.to,"Invitation refused turned off\nTo turn on please specify the number of people and send")
                        else:
                            adanncuy.sendText(msg.to,"关了邀请拒绝。要时开请指定人数发送")
                    else:
                        num =  int(strnum)
                        wait["autoCancel"]["on"] = True
                        if wait["lang"] == "JP":
                            adanncuy.sendText(msg.to,strnum + " The group of people and below decided to automatically refuse invitation")
                        else:
                            adanncuy.sendText(msg.to,strnum + "使人以下的小组用自动邀请拒绝")
                except:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Value is wrong")
                    else:
                        adanncuy.sendText(msg.to,"Bizarre ratings")
                ...
                if wait["timeline"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        adanncuy.sendText(msg.to,"要了关断。")
  
            elif msg.text in ["Like on","เปิด ไลค์"]:
                if wait["likeOn"] == True:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"เปิดอยู่แล้ว。")
                else:
                    wait["likeOn"] = True
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"เปิดระบบออโต้ไลค์.👌")

            elif msg.text in ["ปิด ไลค์","Like off"]:
                if wait["likeOn"] == False:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"ปิดอยู่แล้ว")
                else:
                    wait["likeOn"] = False
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"ปิดระบบออโต้ไลค์.👌")
...
#========================================
                ...
                if wait["Protectcanadanncuy"] == True: md+="􀬁􀆐􏿿 Cancel : ✔ 􀜁􀄯􏿿\n"
                ...
                if wait["adanncuyock"] == True: md+="􀬁􀆐􏿿 ชื่อ นาฬิกา : ✔ 􀜁􀄯􏿿\n"
...
#========================================
		...
		if msg.from_ in Creator:
		    adanncuy.sendText(msg.to, "เชลบอท ได้รีสตาร์ตแล้ว.👌\nกรุณาตั้งค่าใหม่อีกครั้ง.👈")
		    restart_program()
		    print "@Restart"
		else:
...
#========================================
                ...
                if msg.toType == 2:
                        G = adanncuy.getGroup(msg.to)
                        ginfo = adanncuy.getGroup(msg.to)
                        adanncuy.sendText(msg.to,"waitting...")
                        ki1.leaveGroup(msg.to)
                        ki2.leaveGroup(msg.to)
                        ki3.leaveGroup(msg.to)
                        ki4.leaveGroup(msg.to)
...
#================================================#           
	           ...
	           if msg.from_ in admin:
                    ...
                    try:
                       adanncuy.findAndAddContactsByMid(gCreator)
                       adanncuy.inviteIntoGroup(msg.to,[gCreator])
...
#============================
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki1.adanncuyoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki2.adanncuyoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki3.adanncuyoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki4.adanncuyoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki5.adanncuyoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki6.adanncuyoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki7.adanncuyoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki8.adanncuyoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki9.adanncuyoneContactProfile(target)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               ki10.adanncuyoneContactProfile(target)
...
#================================
		...
		if msg.from_ in Creator:
                    ...
                    adanncuy.updateGroup(X)
                    invsend = 0
                    Ti = adanncuy.reissueGroupTicket(msg.to)
		    ...
		    adanncuy.sendText(msg.to,"Lu sape!")
#================================= 
            elif msg.text in ["Backup:on","Backup on","เปิด ดึงกลับ","เปิดการเชิญกลับ"]:
                if wait["Backup"] == True:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Sudah on Bos\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        adanncuy.sendText(msg.to,"Backup On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    wait["Backup"] = True
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Backup On\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["Backup"] == False:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Sudah off Bos\n\n"+ datetime.today().strftime('%H:%M:%S'))
                    else:
                        adanncuy.sendText(msg.to,"Backup Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
                else:
                    wait["Backup"] = False
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Backup Off\n\n"+ datetime.today().strftime('%H:%M:%S'))
...
#===========================================#
                ...
                if wait["lang"] == "JP":
                    adanncuy.sendText(msg.to,"ปฎิเสธกลุ่มเชิญเรียบร้อยแล้ว.👌")
...
#=============================================#
                    ...
                    if not LINEVITLogged:
                        ...
                        tm = "\n\n"+nowT+":"+nowM+":"+nowS
                        adanncuy.sendText(user1,"ล็อกอินสำเร็จ พร้อมใช้งานแล้ว (｀・ω・´)"+tm)
                    else:
                        adanncuy.sendText(msg.to,"ได้ทำการล็อคอินไปแล้ว")
            elif msg.text.lower() == ".":
                    gs = []
                    try:
                        gs = adanncuy.getGroup(msg.to).members
                    except:
                        try:
                            gs = adanncuy.getRoom(msg.to).contacts
                        except:
                            pass
                    tlist = ""
                    for i in gs:
                    ...
                    if AsulLogged == True:
                        ...
                        adanncuy.sendText(msg.to,"ยังไม่ได้ล็อคอิน")
#========================================#
                ...
                if wait["lang"] == "JP":
                    ...
                    adanncuy.sendText(msg.to,"拒绝了全部的邀请。")
            elif msg.text in ["Y1 rgroups","Y1 rgroup"]:
                gid = ki.getGroupIdsInvited()
                for i in gid:
                    ki.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    ki.sendText(msg.to,"Bot All invitations is adanncuyean")
                else:
                ...
                adanncuy.sendText(msg.to,"ทำการลบเรียบร้อย👌")
                adanncuy.sendText(msg.to,"Ok")
...
#                for g in gs.members:
#                    if _nametarget == g.displayName:
#                       adanncuy.sendText(msg.to,"เริ่มทำการรัน")
#                       adanncuy.sendText(g.mid,"[☬Ŧ€ΆM฿❂Ŧ↔Pђãỳãƒir€☬]\n[By.☬adanncuy☬]\n http://line.me/ti/p/adanncuy")
#                       adanncuy.sendText(msg.to, "ทำการรันเรียบร้อย")
#                       print "Done spam"
#========================================

            elif msg.text.lower() == 'ออน':  
                adanncuy.sendText(msg.to, "โปรดรอสักครู่....")
...
#========================================
                ...
                adanncuy.sendText(msg.to,"message changed\n\n"+ datetime.today().strftime('%H:%M:%S'))
                ...
                if wait["lang"] == "JP":
                    adanncuy.sendText(msg.to,"message change to\n\n" + wait["message"])
                else:
                    adanncuy.sendText(msg.to,"The automatic appending information is set as follows。\n\n" + wait["message"])
            elif "Coms set:" in msg.text:
                c = msg.text.replace("คอมเม้น:","Coms set:","")
                if c in [""," ","\n",None]:
                    adanncuy.sendText(msg.to,"String that can not be changed")
                else:
                    wait["comment"] = c
                    adanncuy.sendText(msg.to,"changed\n\n" + c)
                ...
                adanncuy.sendText(msg.to,"message changed to\n\n" + str(wait["comment"]))
            elif msg.text in ["HHX1","Hhx1"]:
                adanncuy.sendText(msg.to,"[เช็คข้อความต้อนรับของคุณ]\n\n" + str(wait["acomment"]))

            elif msg.text in ["HHX2","Hhx2"]:
                adanncuy.sendText(msg.to,"[เช็คข้อความกล่าวถึงคนออกจากกลุ่ม]\n\n" + str(wait["bcomment"]))

            elif msg.text in ["HHX3","Hhx3"]:
                adanncuy.sendText(msg.to,"[เช็คข้อความกล่าวถึงคนลบสมาชิก]\n\n" + str(wait["ccomment"]))

            elif "Hhx1:" in msg.text:
                c = msg.text.replace("Hhx1:","")
                if c in [""," ","\n",None]:
                    adanncuy.sendText(msg.to,"เกิดข้อผิดพลาด..!!")
                else:
                    wait["acomment"] = c
                    adanncuy.sendText(msg.to,"➠ ตั้งค่าข้อความต้อนรับ👌\n\n" + c)
                ...
                if c in [""," ","\n",None]:
                    ...
                    wait["bcomment"] = c
                    adanncuy.sendText(msg.to,"➠ ตั้งค่าข้อความกล่าวถึงคนออกจากกลุ่ม👌\n\n" + c)
                ...
                if c in [""," ","\n",None]:
                    ...
                    wait["ccomment"] = c
                    adanncuy.sendText(msg.to,"➠ ตั้งค่าข้อความกล่าวถึงคนลบสมาชิก👌\n\n" + c)

            elif msg.text in ["Hhx1 on"]:
                if wait["acommentOn"] == True:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"➠ เปิดข้อความต้อนรับเเล้ว👌")
                    else:
                        adanncuy.sendText(msg.to,"Already on")
                else:
                ...
                if wait["bcommentOn"] == True:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"➠ เปิดข้อความกล่าวถึงคนออกจากกลุ่ม👌")
                    else:
                        adanncuy.sendText(msg.to,"Already on")
                else:
                ...
                if wait["ccommentOn"] == True:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"➠ เปิดข้อความกล่าวถึงคนลบสมาชิก👌")
                    else:
                        adanncuy.sendText(msg.to,"Already on")
                else:
                ...
                if wait["acommentOn"] == False:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"➠ ปิดข้อความต้อนรับเเล้ว👌")
                    else:
                        adanncuy.sendText(msg.to,"Already off")
                else:
                ...
                if wait["bcommentOn"] == False:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"➠ ปิดข้อความกล่าวถึงคนออกจากกลุ่ม👌")
                    else:
                        adanncuy.sendText(msg.to,"Already off")
                else:
                ...
                if wait["ccommentOn"] == False:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"➠ ปิดข้อความกล่าวถึงคนลบสมาชิก👌")
                    else:
                        adanncuy.sendText(msg.to,"Already off")
                else:
                ...
                if msg.toType == 2:
                    ...
                    gurl = adanncuy.reissueGroupTicket(gid)
...
#========================================
                ...
                wait["wblack"] = True
                adanncuy.sendText(msg.to,"add to comment bl")
            elif msg.text in ["Comment wl "]:
                wait["dblack"] = True
                adanncuy.sendText(msg.to,"wl to comment bl")
            elif msg.text in ["Comment bl confirm"]:
                if wait["commentBlack"] == {}:
                    adanncuy.sendText(msg.to,"confirmed")
                else:
                    adanncuy.sendText(msg.to,"Blacklist s")
                    mc = ""
                    for mi_d in wait["commentBlack"]:
                        mc += "・" +adanncuy.getContact(mi_d).displayName + "\n"
                    adanncuy.sendText(msg.to,mc)

            elif msg.text in ["เปิด นาฬิกา","adanncuyock:on","adanncuyock on","Jam on","Jam:on"]:
                if wait["adanncuyock"] == True:
                    adanncuy.sendText(msg.to,"already on")
                else:
                    wait["adanncuyock"] = True
                    now2 = datetime.now()
            ...
            elif msg.text in ["ปิด นาฬิกา","adanncuyock:off","adanncuyock off","Jam off","Jam:off"]:
                if wait["adanncuyock"] == False:
                    adanncuy.sendText(msg.to,"already off")
                else:
                    wait["adanncuyock"] = False
                    adanncuy.sendText(msg.to,"done")
                ...
                if len(n.decode("utf-8")) > 13:
                    ...
                    wait["cName"] = n
                    adanncuy.sendText(msg.to,"Changed to:\n\n" + n)
            elif msg.text in ["Up"]:
                if wait["adanncuyock"] == True:
                    now2 = datetime.now()
                    nowT = datetime.strftime(now2,"༺%H:%M༻")
                    ...
                    profile.displayName = wait["cName"] + nowT
                    adanncuy.updateProfile(profile)
                    adanncuy.sendText(msg.to,"Refresh to update")
                else:
                    adanncuy.sendText(msg.to,"Please turn on the name adanncuyock")
                 ...
                 tts.save('tts.mp3')
                 adanncuy.sendImage(msg.to,"steal.png")
                 adanncuy.sendText(msg.to,"DITAMPILKAN UNTUK TEXT\n" + "" + kata + "\n「SUKSES」")
                 adanncuy.sendAudio(msg.to,'tts.mp3')
...
#========================================
                ...
                contact = adanncuy.getContact(umid)
                try:
                    image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                except:
                ...
                if msg.toType == 2:
                    ...
                    for g in group.members:
                        if _name == g.displayName:
                            targets.append(g.mid)
                    if targets == []:
                        adanncuy.sendText(msg.to,"Gak da orange")
                    else:
                        for target in targets:
                            try:
                                contact = adanncuy.getContact(target)
                    ...
                    adanncuy.sendText(msg.to,"Tidak bisa dilakukan di luar grup")
...
#========================================
                ...
                try:
                    adanncuy.updateDisplayPicture(mybackup.pictureStatus)
                    adanncuy.updateProfile(mybackup)
                    adanncuy.sendText(msg.to, "Backup Sukses Bosqu")
                except Exception as e:
                    adanncuy.sendText(msg.to, str (e))
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print rom
                                chiya += rom[1] + "\n"
                        adanncuy.sendText(msg.to, "%s\n\n%s\nReadig point creation:\n [%s]\n"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                    else:
                        adanncuy.sendText(msg.to, "Ketik Lurking dulu dudul Baru bilang result Point.")
...
#-----------------------------------------------
              ...
              if msg.from_ in admin:
                if wait["Notifed"] == True:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"All Notifed On\n\nเปิดเเจ้งเเตือนของคุณเเล้ว")
                    else:
                        adanncuy.sendText(msg.to,"Done\n\nเปิดเเจ้งเเตือนของคุณเเล้ว")
                else:
                    wait["Notifed"] = True
              ...
              if msg.from_ in admin:
                if wait["Notifed"] == False:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"All Notifed Off\n\nปิดเเจ้งเเตือนของคุณเเล้ว")
                    else:
                        adanncuy.sendText(msg.to,"Done\n\nปิดเเจ้งเเตือนของคุณเเล้ว")
                else:
                    wait["Notifed"] = False
              ...
              if msg.from_ in admin:
                if wait["Notifedbot"] == True:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"All bot Notifed On\n\nเปิดเเจ้งเเตือนบอทเเล้ว")
                    else:
                        adanncuy.sendText(msg.to,"Done\n\nเปิดเเจ้งเเตือนบอทเเล้ว")
                else:
              ...
              if msg.from_ in admin:
                if wait["Notifedbot"] == False:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"All bot Notifed Off\n\nปิดเเจ้งเเตือนบอทเเล้ว")
                    else:
                        adanncuy.sendText(msg.to,"Done\n\nปิดเเจ้งเเตือนบอทเเล้ว")
                else:
...
#=================================================
                ...
                if msg.from_ in admin:
                   ...
                   if txt[1] == "on":
                        if jmlh <= 10000:
                             for x in range(jmlh):
                                   adanncuy.sendText(msg.to, teks)
                        else:
                               adanncuy.sendText(msg.to, "Out of range! ")
                   elif txt[1] == "off":
                         if jmlh <= 10000:
                               adanncuy.sendText(msg.to, tulisan)
                         else:
                               adanncuy.sendText(msg.to, "Out of range! ")
#-----------------------------------------------
            elif "Mid @" in msg.text:
...
#-------------------------------------------------
                        ...
                        adanncuy.sendText(msg.to,"[SELF BOT]\n[By.☬adanncuy☬]")
                        adanncuy.sendText(msg.to,"Please wait......")
                        adanncuy.sendText(msg.to,"Turn on all protection")
                        adanncuy.sendText(msg.to,"Qr:on")
                        adanncuy.sendText(msg.to,"Backup:on")
                        adanncuy.sendText(msg.to,"Read:on")
                        adanncuy.sendText(msg.to,"Respon:on")
                        adanncuy.sendText(msg.to,"Responkick:on")
                        adanncuy.sendText(msg.to,"Protect:on")
                        adanncuy.sendText(msg.to,"Namelock:on")
                        adanncuy.sendText(msg.to,"Blockinvite:on")


            elif msg.text in ["ปิดหมด","Phet All off","Phet all off"]:
                        adanncuy.sendText(msg.to,"[SELFBOT]\n[By.☬adanncuy☬]")
                        adanncuy.sendText(msg.to,"Please wait......")
                        adanncuy.sendText(msg.to,"Turn off all protection")
                        adanncuy.sendText(msg.to,"Qr:off")
                        adanncuy.sendText(msg.to,"Backup:off")
                        adanncuy.sendText(msg.to,"Read:off")
                        adanncuy.sendText(msg.to,"Respon:off")
                        adanncuy.sendText(msg.to,"Responkick:off")
                        adanncuy.sendText(msg.to,"Protect:off")
                        adanncuy.sendText(msg.to,"Namelock:off")
                        adanncuy.sendText(msg.to,"Blockinvite:off")
                        adanncuy.sendText(msg.to,"Link off")

 
            elif msg.text in ["ทีมงาน"]:
                msg.contentType = 13
                adanncuy.sendText(msg.to, "[TEAM SELFBOT]\n[By.☬adanncuy☬]")
                adanncuy.sendText(msg.to, "ผู้สร้าง.. SELFBOT\nBy.🔯adanncuy🔯")
                msg.contentMetadata = {'mid': 'uf0bd4970771f26a8cef66473d59bcc69'}
                adanncuy.sendMessage(msg)
                adanncuy.sendText(msg.to, "ผู้จัดการ .SELFBOT\nBy.☬adanncuy☬")
                msg.contentMetadata = {'mid': 'u6c8aab6ee167a596be2cf045ee2f90df'}
                adanncuy.sendMessage(msg)
                adanncuy.sendText(msg.to, "หวานใจ\nBy.ผู้สร้างพญาไฟ")
                msg.contentMetadata = {'mid': 'u2743230861d1c637647d9ca2a8c1fc14'}
                adanncuy.sendMessage(msg)
                adanncuy.sendText(msg.to, "ประธาน:")
                msg.contentMetadata = {'mid': 'u5b671f4148aa5bbec186b5b7cb295271'}
                adanncuy.sendMessage(msg)
                adanncuy.sendText(msg.to, "รองประธาน:💫 By. พยัค")
                msg.contentMetadata = {'mid': 'u7988143c47d3faacf1856a72011eea93'}
                adanncuy.sendMessage(msg)
                adanncuy.sendText(msg.to, "รปภ.:SELFBOT")
                msg.contentMetadata = {'mid': 'u5b671f4148aa5bbec186b5b7cb295271'}
                adanncuy.sendMessage(msg)
                adanncuy.sendText(msg.to, "ตัวเเทนสมาชิก:By.บอล")
...
#-----------------------------------------------------------
                ...
                try:
                    ...
                    adanncuy.sendText(msg.to,str(adanncuy.channel.createAlbumF(msg.to,name,amid)))
                except Exception as e:
                    try:
                        adanncuy.sendText(msg.to,str(e))
                    except:
                        ...
                        if targets == []:
                            ...
                            for target in targets:
                                try:
                                    ...
                                    f=codecs.open('st2__b.json','w','utf-8')
                                    json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                    adanncuy.sendText(msg.to,"Success Boss")
                                except:
                                    adanncuy.sendText(msg.to,"error")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                adanncuy.sendText(msg.to,"Success Masuk daftar orang bejat Boss")
                            except:
                                adanncuy.sendText(msg.to,"Error")
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                f=codecs.open('st2__b.json','w','utf-8')
                                json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                                adanncuy.sendText(msg.to,"Sudah di keluarkan dari daftar bejat Boss")
                            except:
                                adanncuy.sendText(msg.to,"There was no blacklist user")
            elif msg.text in ["adanncuyear ban","ล้างดำ"]:
				wait["blacklist"] = {}
				adanncuy.sendText(msg.to,"adanncuyear")
				
            elif msg.text in ["Ban"]:
                wait["wblacklist"] = True
                adanncuy.sendText(msg.to,"send contact to ban")
                ...
                if wait["blacklist"] == {}:
                    adanncuy.sendText(msg.to,"Nothing 􀨁􀄻double thumbs up􏿿")
                else:
                    adanncuy.sendText(msg.to,"Daftar Banlist􏿿")
                    mc = "[⎈]Blacklist [⎈]\n"
                ...
                if msg.toType == 2:
                    ...
                    for mm in matched_list:
                        cocoa += "\n" + mm + "\n"
                    adanncuy.sendText(msg.to,cocoa + "")

#=============================================
                        
            elif msg.text in ["Simisimi on","Simisimi:on"]:
                settings["simiSimi"][msg.to] = True
                adanncuy.sendText(msg.to,"Success activated simisimi")
                
            elif msg.text in ["Simisimi off","Simisimi:off"]:
                settings["simiSimi"][msg.to] = False
                adanncuy.sendText(msg.to,"Success deactive simisimi")
                
            elif msg.text in ["เปิด อ่าน","Read on","Read:on"]:
                wait['alwayRead'] = True
                adanncuy.sendText(msg.to,"เปิดอ่านข้อความอัตโนมัติ.👌")
                
            elif msg.text in ["ปิด อ่าน","Read off","Read:off"]:
                wait['alwayRead'] = False
                adanncuy.sendText(msg.to,"ปิดอ่านข้อความอัตโนมัติ.👌")
                
            elif msg.text in ["Tag on","Autorespon:on","Respon on","Respon:on"]:
                wait["detectMention"] = True
                adanncuy.sendText(msg.to,"Auto Respon ON")
                
            elif msg.text in ["Tag off","Autorespon:off","Respon off","Respon:off"]:
                wait["detectMention"] = False
                adanncuy.sendText(msg.to,"Auto Respon OFF")

            elif msg.text in ["Tag1","Tag1"]:
                adanncuy.sendText(msg.to,"ข้อความแทคล่าสุดคือ\n\n" + str(wait["tag1"]))
                ...
                adanncuy.sendText(msg.to,"Auto Kick ON")
                
            elif msg.text in ["Kicktag off","Autokick:off","Responkick off","Responkick:off"]:
                wait["kickMention"] = False
                adanncuy.sendText(msg.to,"Auto Kick OFF")

            elif msg.text in ["Cancel on","cancel on"]:
              if msg.from_ in admin:
                if wait["Protectcanadanncuy"] == True:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Cancel Semua Undangan On")
                    else:
                        adanncuy.sendText(msg.to,"done")
                else:
                    wait["Protectcanadanncuy"] = True
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Cancel Semua Undangan On")
                    else:
                        adanncuy.sendText(msg.to,"done")
              ...
              if msg.from_ in admin:
                if wait["Protectcanadanncuy"] == False:
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Cancel Semua Undangan Off")
                    else:
                        adanncuy.sendText(msg.to,"done")
                else:
                    wait["Protectcanadanncuy"] = False
                    if wait["lang"] == "JP":
                        adanncuy.sendText(msg.to,"Cancel Semua Undangan Off")
                    else:
                        adanncuy.sendText(msg.to,"done")
...
#==============================================================================#
                ...
                adanncuy.sendMessage(msg)
                contact = adanncuy.getContact(saya)
                cu = adanncuy.channel.getCover(saya)
                path = str(cu)
                image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                try:
                    adanncuy.sendText(msg.to,"Nama :\n" + contact.displayName + "\n\nBio :\n" + contact.statusMessage)
                ...
                gid = adanncuy.getGroupIdsJoined()
                for i in gid:
                    h = adanncuy.getGroup(i).id
                    group = adanncuy.getGroup(i)
                    if h == saya:
                        try:
                            ...
                            adanncuy.sendText(msg.to,md)
                            adanncuy.sendMessage(msg)
                            adanncuy.sendImageWithUrl(msg.to,"http://dl.profile.line.naver.jp/"+ group.pictureStatus)
                        except:
                            creator = "Error"
                ...
                gid = adanncuy.getAllContactIds()
                for i in gid:
                    h = adanncuy.getContact(i).displayName
                    contact = adanncuy.getContact(i)
                    cu = adanncuy.channel.getCover(i)
                    path = str(cu)
                    image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                    if h == saya:
                        adanncuy.sendText(msg.to,"Nama :\n" + contact.displayName + "\n\nBio :\n" + contact.statusMessage)
                ...
                gid = adanncuy.getGroup(msg.to)
                adanncuy.sendText(msg.to, "[Nama Grup : ]\n" + gid.name)
            
            elif "Gid" in msg.text:
                saya = msg.text.replace('Gid','')
                gid = adanncuy.getGroup(msg.to)
                adanncuy.sendText(msg.to, "[ID Grup : ]\n" + gid.id)
                ...
                for i in gid:
                    h += "%s\n" % (adanncuy.getGroup(i).name +" ? ["+str(len(adanncuy.getGroup(i).members))+"]")
                adanncuy.sendText(msg.to,"-- List Groups --\n\n"+ h +"\nTotal groups =" +" ["+str(len(gid))+"]")                            
                ...
                if msg.to in wait2['readPoint']:
                    ...
                    with open('sider.json', 'w') as fp:
                     json.dump(wait2, fp, sort_keys=True, indent=4)
                     adanncuy.sendText(msg.to, "เปิดการอ่านอัตโนมัต\nSet reading point:\n" + datetime.now().strftime('%H:%M:%S'))
                     print wait2
                ...
                if msg.to not in wait2['readPoint']:
                    ...
                    try:
                          ...
                          pass
                    adanncuy.sendText(msg.to, "ปิดการอ่านอัตโนมัต\nDelete reading point:\n" + datetime.now().strftime('%H:%M:%S'))
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        adanncuy.sendText(msg.to, "Lurking has not been set.")

            elif msg.text in ["เปิดอ่าน","R on","ตั้งเวลา"]:
                        adanncuy.sendText(msg.to,"lurk on")
            elif msg.text in ["ปิดอ่าน","R off"]:
                        adanncuy.sendText(msg.to,"lurk off")
                        ...
                        adanncuy.sendText(msg.to,"lurkers")
                        adanncuy.sendText(msg.to,"lurkers")
                        adanncuy.sendText(msg.to,"llurkers")
                        adanncuy.sendText(msg.to,"lurkers")
                        adanncuy.sendText(msg.to,"lurkers")
                        adanncuy.sendText(msg.to,"lurkers")
                        adanncuy.sendText(msg.to,"lurkers")
            ...
            elif msg.text in ["Miadanncuyist","Heckmic"]:
                        if mimic["target"] == {}:
                ...
                adanncuy.sendText(msg.to, "Pap telah di Set")
            elif msg.text in ["Papimage","Papim","Pap"]:
                adanncuy.sendImageWithUrl(msg.to,wait["pap"])
            elif "Setvideo: " in msg.text:
                wait["pap"] = msg.text.replace("Setvideo: ","")
                adanncuy.sendText(msg.to,"Video Has Ben Set To")
            elif msg.text in ["Papvideo","Papvid"]:
                adanncuy.sendVideoWithUrl(msg.to,wait["pap"])
#==============================================================================#
            elif msg.text in ["Sk"]:
                msg.contentType = 7
                msg.text = None
                ...
                adanncuy.sendText(msg.to,"line://home/post?userMid="+mid+"&postId="+adanncuy.new_post(tl_text)["result"]["post"]["postInfo"]["postId"])
                ...
                if len(string.decode('utf-8')) <= 10000000000:
                    ...
                    profile.displayName = string
                    adanncuy.updateProfile(profile)
                    adanncuy.sendText(msg.to,"Changed " + string + "")
                ...
                if len(string.decode('utf-8')) <= 10000000000:
                    ...
                    h = adanncuy.getContact(mid)
                    adanncuy.sendVideoWithUrl(msg.to,"http://dl.profile.line-cdn.net/" + h.pictureStatus)
            elif msg.text in ["ลิ้งรูป","Mey4"]:
                    h = adanncuy.getContact(mid)
                    adanncuy.sendText(msg.to,"http://dl.profile.line-cdn.net/" + h.pictureStatus)
            elif msg.text in ["ปก","Mey5"]:
                    h = adanncuy.getContact(mid)
                    cu = adanncuy.channel.getCover(mid)          
                    path = str(cu)
                    adanncuy.sendImageWithUrl(msg.to, path)
                ...
                adanncuy.sendImageWithUrl(msg.to,path)
                   ...
                   if targets == []:
                       ...
                       for target in targets:
                            try:
                               adanncuy.adanncuyoneContactProfile(target)
                               adanncuy.sendText(msg.to, "Copied.")
                            except Exception as e:
                                print e
            elif msg.text in ["Mybb"]:
                try:
                    adanncuy.updateDisplayPicture(backup.pictureStatus)
                    adanncuy.updateProfile(backup)
                    adanncuy.sendText(msg.to, "Refreshed.")
                except Exception as e:
                    adanncuy.sendText(msg.to, str(e))
 
#==========================================================#
            elif "[Auto Respond]" in msg.text:
                adanncuy.sendImageWithUrl(msg.to, "http://dl.profile.line.naver.jp/0hlGvN3GXvM2hLNx8goPtMP3dyPQU8GSIgJVUpCTpiPVtiA3M2adanncuyJ-C2hia11mUn04cAJ-DWljOVBj")
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                adanncuy.sendText(msg.to,"----FROM ID----\n" + "" + kata + "\n----TO ENGLISH----\n" + "" + result + "\n------SUKSES-----")
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                adanncuy.sendText(msg.to,"----FROM EN----\n" + "" + kata + "\n----TO ID----\n" + "" + result + "\n------SUKSES-----")
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                adanncuy.sendText(msg.to,"----FROM JP----\n" + "" + kata + "\n----TO ID----\n" + "" + result + "\n------SUKSES-----")
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                adanncuy.sendText(msg.to,"----FROM TH----\n" + "" + kata + "\n----TO ID----\n" + "" + result + "\n------SUKSES-----")
            elif "Id@jp" in msg.text:
                bahasa_awal = 'id'
                bahasa_tujuan = 'ja'
                kata = msg.text.replace("Id@jp ","")
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                adanncuy.sendText(msg.to,"----FROM AR----\n" + "" + kata + "\n----TO ID----\n" + "" + result + "\n------SUKSES-----")
                ...
                result = page[page.find(cari_hasil)+len(cari_hasil):]
                result = result.split("<")[0]
                adanncuy.sendText(msg.to,"----FROM KO----\n" + "" + kata + "\n----TO ID----\n" + "" + result + "\n------SUKSES-----")
                
            elif msg.text.lower() == 'welcome':
                ginfo = adanncuy.getGroup(msg.to)
                adanncuy.sendText(msg.to,"Selamat Datang Di Grup " + str(ginfo.name))
                jawaban1 = ("ยินดีต้อนรับเข้าสู่กลุ่ม " + str(ginfo.name))
                adanncuy.sendText(msg.to,"Owner Grup " + str(ginfo.name) + " :\n" + ginfo.creator.displayName )
                tts = gTTS(text=jawaban1, lang='th')
                tts.save('hasil.mp3')
                adanncuy.sendAudioWithUrl(msg.to,'hasil.mp3')
                ...
                adanncuy.sendAudioWithUrl(msg.to,"hasil.mp3")
                  ...
                  tts.save('tts.mp3')
                  adanncuy.sendAudioWithUrl(msg.to,'tts.mp3')
                ...
                try:
                    ...
                    adanncuy.sendVideoWithUrl(msg.to, ght)
                except:
                    adanncuy.sendText(msg.to,"Could not find it")            
                ...
                try:
                  ...
                  try:
                      ...
                      adanncuy.sendText(msg.to, pesan)
                  except:
                          try:
                              pesan="Over Text Limit! Please adanncuyick link\n"
                              pesan+=wikipedia.page(wiki).url
                              adanncuy.sendText(msg.to, pesan)
                          except Exception as e:
                              adanncuy.sendText(msg.to, str(e))
                ...
                try:
                    ...
                    for song in data:
                        ...
                        adanncuy.sendText(msg.to, hasil)
                        adanncuy.sendText(msg.to, "Please Wait for audio...")
                        adanncuy.sendAudioWithUrl(msg.to, song[4])
                ...
                try:
                    ...
                    try:
                        ...
                        text = "Name : "+namaIG+"\nUsername : "+usernameIG+"\nBiography : "+bioIG+"\nFollower : "+followerIG+"\nFollowing : "+followIG+"\nPost : "+mediaIG+"\nVerified : "+verifIG+"\nPrivate : "+privateIG+"" "\n" + link
                        adanncuy.sendImageWithUrl(msg.to, profileIG)
                        adanncuy.sendText(msg.to, str(text))
                    except Exception as e:
                        adanncuy.sendText(msg.to, str(e))
...
#========================================================#
                ...
                if wait["blacklist"] == {}:
                    adanncuy.sendText(msg.to,"Tidak Ada Blacklist")
                else:
                    adanncuy.sendText(msg.to,"Daftar Banlist")
                    num=1
                    msgs="══════════List Blacklist═════════"
                    for mi_d in wait["blacklist"]:
                        msgs+="\n[%i] %s" % (num, adanncuy.getContact(mi_d).displayName)
                        num=(num+1)
                ...
                if wait["blacklist"] == {}:
                    ...
                    adanncuy.sendText(msg.to,"Daftar Blacklist")
                    h = ""
                    for i in wait["blacklist"]:
                        h = adanncuy.getContact(i)
                        M = Message()
                        M.to = msg.to
                        M.contentType = 13
...
#==============================================#
              ...
              if msg.from_ in admin:
                ...
                cu = adanncuy.channel.getCover(key1)
                try:
                    adanncuy.sendText(msg.to,"[name]\n" + contact.displayName + "\n[mid]\n" + contact.mid + "\n[statusmessage]\n" + contact.statusMessage + "\n[profilePicture]\nhttp://dl.profile.line-cdn.net/" + contact.pictureStatus + "\n[homePicture]\n" + str(cu))
                except:
                    adanncuy.sendText(msg.to,"[name]\n" + contact.displayName + "\n[mid]\n" + contact.mid + "\n[statusmessage]\n" + contact.statusMessage + "\n[homePicture]\n" + str(cu))
#=============================================
            elif msg.text in ["!Sp"]:
                start = time.time()
                adanncuy.sendText(msg.to, "Waiting...")
                elapsed_time = time.time() - start
                adanncuy.sendText(msg.to, "%sTamii Server" % (elapsed_time))
              ...
              if msg.from_ in admin:
                ...
                for target in targets:
                   try:
                      ...
                      f=codecs.open('st2__b.json','w','utf-8')
                      json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                      adanncuy.sendText(msg.to,"Succes Banned Bos")
                   except:
                      pass        
       #-------------Fungsi Respon Start---------------------#
                ...
                if wait["blacklist"] == {}:
                    ...
                    xname = ""
                    for mi_d in wait["blacklist"]:
                        xname = adanncuy.getContact(mi_d).displayName + ""
                ...
                G = adanncuy.getProfile()
                X = G.displayName
                adanncuy.sendText(msg.to,X)
                    ...
                    with requests.session() as s:
                        ...
                        r    = s.get(url, params=params)
                        mp3  = r.url
                        adanncuy.sendAudioWithUrl(msg.to, mp3)
            elif "siri:" in msg.text.lower():
                    query = msg.text.lower().replace("siri:","")
                    with requests.session() as s:
                        s.headers['user-agent'] = 'Mozilla/5.0'
                  ...
                  try:
                      ...
                      adanncuy.sendText(msg.to, pesan)
                          ...
                          try:
                              pesan="Text Terlalu Panjang Silahkan adanncuyick link di bawah ini\n"
                              pesan+=wikipedia.page(wiki).url
                              adanncuy.sendText(msg.to, pesan)
                          except Exception as e:
                              adanncuy.sendText(msg.to, str(e))
                ...
                ultah = data["data"]["ultah"]
                zodiak = data["data"]["zodiak"]
                adanncuy.sendText(msg.to,"Tanggal Lahir : "+lahir+"\n\nUmur : "+usia+"\n\nUltah : "+ultah+"\n\nZodiak : "+zodiak)
            elif "deadanncuyined" in msg.text:
                if msg.toType == 2:
                    ginfo = adanncuy.getGroup(msg.to)
                    try:
        ...
        if op.type == 25:
            ...
            if msg.text.lower() in ["pheytcg fgtagg all"]:
                ...
                if jml > 400 and jml < 500:
                    ...
                    mention(msg.to, nm5)
                if jml > 500:
                    adanncuy.sendText(msg.to,'Member melebihi batas.')
                cnt = Message()
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                adanncuy.sendMessage(cnt)
                        ...
                        adanncuy.sendText(msg.to,"😆เช็คจัง กลัวบอทหลุด ล่ะสิ😆")

            elif msg.text in ["เทสบอท"]:
                        adanncuy.sendText(msg.to,"SELF BOT\n[By.☬adanncuy☬]")

            elif msg.text in [".อยู่ไหม"]:
                        adanncuy.sendText(msg.to,"อยู่...")

            elif msg.text in ["/อยู่ไหม"]:
                        adanncuy.sendText(msg.to,"เรื่องของกู...")

            elif msg.text in ["/ออนไหม"]:
                        adanncuy.sendText(msg.to,"ออน")

            elif msg.text in ["/ปิดป้องกัน"]:
                        adanncuy.sendText(msg.to,"ปิดป้องกัน")
                ...
                if msg.to in wait2['readPoint']:
                    ...
                    with open('sider.json', 'w') as fp:
                     json.dump(wait2, fp, sort_keys=True, indent=4)
                     adanncuy.sendText(msg.to, "โปรเเกรมเปิดการอ่านอัตโนมัต\nSet reading point:\n" + datetime.now().strftime('%H:%M:%S'))
                     print wait2
                ...
                if msg.to not in wait2['readPoint']:
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        adanncuy.sendText(msg.to, "กรุณาตั้งเวลาการอ่านใหม่อีกครั้งโปรดพิมพ์ ➠ /ตั้งเวลา")
            elif msg.from_ in mimic["target"] and mimic["status"] == True and mimic["target"][msg.from_] == True:
            	text = msg.text
            	if text is not None:
            		adanncuy.sendText(msg.to, "[อัตโนมัติ]: " + text)
            	else:
            		if msg.contentType == 7:
            			msg.contentType = 7
            			msg.text = None
        ...
        if op.type == 26:
            ...
            if msg.contentType == 16:
                ...
                print ("Auto Like By.☬adanncuy☬")

        if op.type == 15:
            if wait["Notifed"] == True:
                if op.param2 in Bots:
                    return
                adanncuy.sendText(op.param1,adanncuy.getContact(op.param2).displayName + "\n􀜁􀄄􏿿 เเล้วพบใหม่นะ 􀜁􀄄􏿿")
        ...
        if op.type == 15:
            if wait["Notifedbot"] == True:
                if op.param2 in Bots:
                    return
                ki1.sendText(op.param1,adanncuy.getContact(op.param2).displayName + "\n\n􀜁??􏿿 Bye~bye 􀜁􀄄􏿿")
                ki2.sendText(op.param1,adanncuy.getContact(op.param2).displayName + "\n\n􀜁􀄄􏿿 Bye~bye 􀜁􀄄􏿿")
                print "MEMBER OUT GROUP"
        ...
        if op.type == 13:
          if wait["Protectcanadanncuy"] == True:
            if op.param2 not in Bots:
              group = adanncuy.getGroup(op.param1)
              gMembMids = [contact.mid for contact in group.invitee]
        ...
        if op.param3 == "1":
            if op.param1 in protectname:
                ...
                try:
					...
					adanncuy.updateGroup(group)
					adanncuy.sendText(op.param1, "Groupname protect now")
					wait["blacklist"][op.param2] = True
					f=codecs.open('st2__b.json','w','utf-8')
					json.dump(wait["blacklist"], f, sort_keys=True, indent=4,ensure_ascii=False)
                except Exception as e:
