...
nadya = LINETCR.LINE()
#nadya.login(qr=True)
nadya.login(token='EuaKLLYhVn2Oj5WfUO07.st19kSEgZtzj8FCaOM2a5W.Sx3egDJr/xm8a47gw2wQbBdPIYPQ+L8UJCT+EYWwO3U=')
nadya.loginResult()
print "ByAdaNcuy Success\n\n=====[Sukses Login]====="
...
Bots=[mid]
Creator=["u3a3d2af88f1113cd00e7934f862af688","ued4da99b9c079e976a23f662d5bace63","uc84bb710a551c8184ce3ae3496bf6142","ucee5ab0cb5b9a8ee020647b0109e54fe","ud228917250f6b6ff5c7364da315d01d9","u4d87413a6bbb0b6951e2dbf282b4b8b9","ucc03fa6899eeeaab61a6f276d1233bbf","u58c175714105855de75b533509bd9033"]
admin=["u3a3d2af88f1113cd00e7934f862af688","ued4da99b9c079e976a23f662d5bace63","uc84bb710a551c8184ce3ae3496bf6142","ucee5ab0cb5b9a8ee020647b0109e54fe","ud228917250f6b6ff5c7364da315d01d9","u4d87413a6bbb0b6951e2dbf282b4b8b9","ucc03fa6899eeeaab61a6f276d1233bbf","u58c175714105855de75b533509bd9033"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment":"Bot Auto Like ©By : AdanNcuy\nContact Me : 👉 line.me/ti/p/~ncuy001",  
    "commentOn":True,
    "commentBlack":{},
...
#                            Name = summon(op.param2)
        ...
        if op.type == 26:
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True:
                     contact = nadya.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag!! Lagi Sibuk",cName + " Ngapain Ngetag Gua lagi Tidur?",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja","Dia Lagi Off Sambil Colly", cName + " Kenapa Tag Saya Dasar Kau Tak Ada Kerjaan Njirr?","Dia Lagi Tidur\nJangan Di Tag " + cName, "Jangan Suka Tag Gua " + cName, "Kamu Siapa " + cName + "?", "Ada Perlu Apa " + cName + "?","Woii " + cName + " Jangan Ngetag, Jones!"]
                     ret_ = random.choice(balas)
                     name = re.findall(r'@(\w+)', msg.text)
                     mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                     mentionees = mention['MENTIONEES']
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention2"] == True:          
                    contact = nadya.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Sekali lagi nge tag gw sumpahin jomblo seumur hidup!","Nggak Usah Tag-Tag! Lu tu Bau Taek Ngapain Tag Gua Njir...","Woii " + cName + " Ngapa Tag Gua, Cari Riibut Kau!"]
                    ret_ = random.choice(balas)
                    name = re.findall(r'@(\w+)', msg.text)
                    mention = ast.literal_eval(msg.contentMetadata['MENTION'])
                    mentionees = mention['MENTIONEES']
            ...
            if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention3"] == True:          
                    contact = nadya.getContact(msg.from_)
                    cName = contact.displayName
                    balas = ["Woii " + cName + ", Dasar Jones Ngetag Mulu Gak Tau Apa Lu jones Permanen!"]
        ...
        if op.type == 26:
          if wait["Bot"] == True:    
            ...
            elif msg.text in ["Creator","Admin"]:
                msg.contentType = 13
                msg.contentMetadata = {'mid': ncuy}                                
                nadya.sendMessage(msg)
		nadya.sendText(msg.to,"Itu Admin Tampan Kami (^_^)")   
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to, "Khusus Untuk Ncuy")
		...
		if msg.from_ in admin:
		    ...
		    nadya.sendText(msg.to, "Khusus Ncuy")
		...
		if msg.from_ in Creator:
                    for i in gid:
                        h = nadya.getGroup(i).name
		        if h == ng:
			    nadya.sendText(i,"Bot Di Paksa Keluar Oleh Admin!")
		            nadya.leaveGroup(i)
		...
		if msg.from_ in admin:
            ...
            elif "Kata Telarang AdanNcuy" == msg.text:
		    if msg.from_ in Creator:        
                     if msg.toType == 2:
                        print "Kick all member"
                        _name = msg.text.replace("Mampus","")
                        gs = nadya.getGroup(msg.to)
                        nadya.sendText(msg.to,"Virus")
                        targets = []
                        for g in gs.members:
                            if _name in g.displayName:
                                targets.append(g.mid)
                        if targets == []:
                            nadya.sendText(msg.to,"Anjing.")
                        else:
                            for target in targets:
				if target not in admin:
                                    try:
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "VIRUS AdanNcuy By Fuck,'"}
                nadya.sendMessage(msg)
