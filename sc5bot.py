...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='Euz24XerOTSzgdFYNVF3.XAmvsdh7y1VwfOzAO7dtOW.mjKu62pjXJuqBlG5EoWNC6TGHSBIY+XSCatgj7F9GPo=')
cl.loginResult()
...
#km.login(qr=True)
km.login(token='Eu4bM3aFx77y7p1qoB56.mQNSHVdhd+XbL3SOs9SyrG.ay/fJzFaJhfn2ZGhk5oJ99Pda6oBRIic29jmCo8t8Ww=')
km.loginResult()
...
│▪〔Invitemeto: (Gid)〕
│▪〔Kapten acc invite〕
│▪〔adanncuy1 acc invite〕
│▪〔adanncuy2 acc invite〕
│▪〔adanncuy3 acc invite〕
│▪〔adanncuy4 acc invite〕
│▪〔Removechat〕
│▪〔Join on/off〕
│▪〔Joincancel on/off〕
│▪〔Respon on/off〕
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u3a3d2af88f1113cd00e7934f862af688"]
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus adanncuy")
...
#		else:                    
		...
		if wait["Simi"] == True: md+="│▪✔️ Simisimi : On\n"
            ...
            elif msg.text in ["adanncuy1 gift","adanncuy1 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["adanncuy2 gift","adanncuy2 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["adanncuy3 gift","adanncuy3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'ae3d9165-fab2-4e70-859b-c14a9d4137c4',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
		...
		if msg.from_ in admin:
            ...
            elif msg.text in ["adanncuy1 join"]:
		if msg.from_ in admin:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
            ...
            elif msg.text in ["adanncuy2 join"]:
		if msg.from_ in admin:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
            ...
            elif msg.text in ["adanncuy3 join"]:
		if msg.from_ in admin:
                    G = cl.getGroup(msg.to)
                    ginfo = cl.getGroup(msg.to)
                    G.preventJoinByTicket = False
            ...
            elif msg.text in ["adanncuy4 join"]:
		if msg.from_ in admin:
                    G = cl.getGroup(msg.to)
                    ginfo = cl.getGroup(msg.to)
                    G.preventJoinByTicket = False
		...
		cl.sendText(msg.to,"Pasukan Absen!!")
                ki.sendText(msg.to,"adanncuy1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"adanncuy2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"adanncuy3 Hadiir  \(ˆ▿ˆ)/")
		...
		if msg.from_ in Creator:
            ...
            elif "adanncuy1 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("adanncuy1 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = ki.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                       ...
                       for target in targets:
                            try:
                               ...
                               ki.sendText(msg.to, "Copied (^_^)")
                                ...
                                print e
            elif "adanncuy2 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("adanncuy2 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kk.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "adanncuy3 copy @" in msg.text:
                   print "[COPY] Ok"
                   _name = msg.text.replace("adanncuy3 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kc.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
            ...
            elif "adanncuy4 copy @" in msg.text:
                   print "[COPY] Ok"
