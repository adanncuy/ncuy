...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EuVRV3NOdz8nEpkuidc8.oJ0Q/i8re80a55npHIR2Ia.yZ2OlEAhcoaK1krolmlK8MjQDZytrubFOz4YnNnQ1Ps=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EtY3xOgllYnt43VH83T6.2PrmHp8c+bFOHFXnPufADG.0eqJ6bUr2i9iU0JdziqZBiwP+9LLteMBDdFoHJmMqLs=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='EtyPrK4aoLf1yDOKqam1.PyjGTnkCa60yyX44bNGlGq.sBb44B0qPbv+jsIIuNXuap64kvnPIv2YzKzaLKcKAok=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EtmUY2ieygihzSn7AQ52.8h3zchDqkkKYbQyoakPUyG.3K0ZaEInyc6AvxUo+63DQ14rzj16TWkkwxEpPbNMec8=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EtUsGbHdw5JTHVIV5Fe6.mQNSHVdhd+XbL3SOs9SyrG.XfRJ9kj3bNBlPlwWwMh9q5NSxQIWb92p9GBGjE1NTGc=')
kr.loginResult()
print "Kr-Login Success\n"

cuy = LINETCR.LINE()
#kr.login(qr=True)
cuy.login(token='Et15jetiY4AtkY77Lls6.G0gahkh72S4FSRsa68eOLG.R+f7dloVCQmtUw1pqrB15ebPRYIsl9PrjDN4Fo9rq2A=')
cuy.loginResult()
print "Cuy-Login Success\n"

km = LINETCR.LINE()
#km.login(qr=True)
km.login(token='Et15jetiY4AtkY77Lls6.G0gahkh72S4FSRsa68eOLG.R+f7dloVCQmtUw1pqrB15ebPRYIsl9PrjDN4Fo9rq2A=')
km.loginResult()
print "Km-Login Success\n\n=====[Sukses All Login- By- AdanNcuy]====="
...
╚═════════════════════════
"""
ncuy="u3a3d2af88f1113cd00e7934f862af688"
...
Cuymid = cuy.getProfile().mid
Emid = km.getProfile().mid
Bots=[mid,Amid,Bmid,Cmid,Dmid,Cuymid,Emid]
Creator=["u3a3d2af88f1113cd00e7934f862af688","u41f97d9e5597453c98ebc7bce6c09053","uc84bb710a551c8184ce3ae3496bf6142","ucee5ab0cb5b9a8ee020647b0109e54fe","ud228917250f6b6ff5c7364da315d01d9","uf26e8ee692bec6961d907d0096806c66","u4d87413a6bbb0b6951e2dbf282b4b8b9","ucc03fa6899eeeaab61a6f276d1233bbf"]
admin=["u3a3d2af88f1113cd00e7934f862af688","u41f97d9e5597453c98ebc7bce6c09053","uc84bb710a551c8184ce3ae3496bf6142","ucee5ab0cb5b9a8ee020647b0109e54fe","ud228917250f6b6ff5c7364da315d01d9","uf26e8ee692bec6961d907d0096806c66","u4d87413a6bbb0b6951e2dbf282b4b8b9","ucc03fa6899eeeaab61a6f276d1233bbf"]
...
contact = cuy.getProfile()
backup6 = cuy.getProfile()
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Jangan Lupa Add Me Bot Saya ^_^..",
    "comment2":"Wkwkwk ＼（○＾ω＾○）／",
    "comment3":"Lucu Banget!!! ヘ(^_^)ヘ",
    "comment7":"Jangan Lupa Share Kontak Admin Maksih!!! ヘ(^_^)ヘ",
    "comment4":"Nice Kak (^_^)",
    "comment6":"Bot Auto Like ©By : AdanNcuy\nContact Me : 👉 line.me/ti/p/~Ncuy001",    
    "comment5":"Thaks You Yang Udah Baca Komenan..",
    "commentOn":True,
                ...
                try:
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            Name = cuy.getContact(op.param2).displayName
	 ...
	 if wait["Ghost"] == True:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 16:
                if wait['likeOn'] == True:
                     ...
                     km.like(url[25:58], url[66:], likeType=1006)
                     cuy.like(url[25:58], url[66:], likeType=1006)
                     ...
                     km.comment(url[25:58], url[66:], wait["comment6"])
                     cuy.comment(url[25:58], url[66:], wait["comment7"])
        ...
        if op.type == 25:
			...
			cl.sendText(msg.to,"Admin Detected~")
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': ncuy}
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Itu Majikan Tampan Kami (^_^)")
		
            elif msg.text in ["Admin","admin"]:
                msg.contentType = 13
                admin1 = "uf26e8ee692bec6961d907d0096806c66"
                admin2 = "uc84bb710a551c8184ce3ae3496bf6142"
                admin3 = "u41f97d9e5597453c98ebc7bce6c09053"
                admin4 = "u4d87413a6bbb0b6951e2dbf282b4b8b9"
                admin5 = "ud228917250f6b6ff5c7364da315d01d9"
                admin6 = "ucee5ab0cb5b9a8ee020647b0109e54fe"
                admin7 = "ucc03fa6899eeeaab61a6f276d1233bbf"
                msg.contentMetadata = {'mid': ncuy}
                ...
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': admin7}
                random.choice(KAC).sendMessage(msg)                                
		random.choice(KAC).sendText(msg.to,"Itu Admin Group ini Tolong Kalo Ada Apa-Apa Bisa PM mereka (^_^)")	
              ...
              if msg.from_ in Creator:
                ...
                if targets == []:
                   ...
                   for target in targets:
                        try:
                            admin.remove(target)
                            cl.sendText(msg.to,"Admin AdanNcuy Dihapus")
                        except:
                            pass
		...
		if msg.from_ in admin:
		    ...
		    cl.sendText(msg.to, "Khusus Ncuy")
...
#		    cl.sendText(msg.to,"Khusus Nadya")
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                cuy.findAndAddContactsByMid(midd)
		...
		if msg.from_ in admin:
		    G = cl.getGroup(msg.to)
                    ...
                    time.sleep(0.2)
                    cuy.acceptGroupInvitationByTicket(msg.to,Ticket)
                    time.sleep(0.2)
		...
		ki.sendText(msg.to,"Pasukan TGF Mafia Absen!!")
                ki.sendText(msg.to,"TGF 1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"TGF 2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"TGF 3 Hadiir  \(ˆ▿ˆ)/")
                kr.sendText(msg.to,"TGF 4 Hadiir  \(ˆ▿ˆ)/")
                km.sendText(msg.to,"TGF 5 Hadiir   \(ˆ▿ˆ)/")
                cuy.sendText(msg.to,"TGF 6 Hadiir   \(ˆ▿ˆ)/")
                cuy.sendText(msg.to,"Semua nya Hadir Bos ku TGF Mafia...")
                ...
                km.sendText(msg.to,responsename1)
                cuy.sendText(msg.to,responsename6)
		...
		if msg.from_ in admin:
            ...
            elif "Mampus" == msg.text:
		    if msg.from_ in Creator:
                     if msg.toType == 2:
                        print "Kick all member"
                        _name = msg.text.replace("Mampus","")
                        gs = ki.getGroup(msg.to)
                        gs = kk.getGroup(msg.to)                        
                        gs = kc.getGroup(msg.to)
                        gs = kr.getGroup(msg.to)
                        gs = km.getGroup(msg.to)
                        cl.sendText(msg.to,"Fuck")
                        cl.sendText(msg.to,"Fuck")
                        cl.sendText(msg.to,"Fuck")
                        cl.sendText(msg.to,"Fuck")
                        cl.sendText(msg.to,"Fuck")
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
            	msg.contentType = 13                
                msg.contentMetadata = {'mid': "Virus By AdanNcuy,'"}
                cl.sendMessage(msg)
                ...
                try:
                    ...
                    cuy.updateDisplayPicture(backup6.pictureStatus)
                    cuy.updateProfile(backup6)
...
#              if msg.from_ in admin:
                cuy.sendText(msg.to,"Aku belum mandi")
                ...
                cuy.sendText(msg.to,"yiha")
                ki.sendText(msg.to,"Kalau orang lain melihatku")
                kk.sendText(msg.to,"Tak tun tuang")
                cuy.sendText(msg.to,"Badak aku taba bana")
                km.sendText(msg.to,"Tak tun tuang")
                ...
                cuy.sendText(msg.to,"Sepi bat")
                kk.sendText(msg.to,"Iya sepi udah udah")
                km.sendText(msg.to,"Gaada yang denger juga kita nyanyi")
                ki.sendText(msg.to,"Nah")
                kk.sendText(msg.to,"Mending gua makan dulu")
                cuy.sendText(msg.to,"Siyap")
                km.sendText(msg.to,"Okeh")
                kk.sendText(msg.to,"Katanya owner kita Jomblo ya")
                cuy.sendText(msg.to,"Iya emang")
                ki.sendText(msg.to,"Denger denger si lagi nyari pacar doi")
                km.sendText(msg.to,"Udah ah gosip mulu doain aja biar dapet")
