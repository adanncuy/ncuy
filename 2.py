...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EuXx5tq48wiifwY907kd.Ttcqr0Ayl7nm7DwkI0qShq.KlHF8UWjbMQzmbqxkY2PmU796K6vU/tueJ8Ty5ha9jE=')
cl.loginResult()
...
kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='Eu2vFHYth4SYOYtLALj6.2PrmHp8c+bFOHFXnPufADG.1XYI+WT5GcYVek6VG9xd5vdZKnMTCTE2f15fDQYqYAY=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='EuH9FzcGTIka9aS3Jth2.8h3zchDqkkKYbQyoakPUyG.G/wG8o1UzDArzyl/MI57WkPPZhH5DXEmGiV1xTAmdYw=')
kr.loginResult()
print "Kr-Login Success\n"

cuy = LINETCR.LINE()
#kr.login(qr=True)
cuy.login(token='Eu4bM3aFx77y7p1qoB56.mQNSHVdhd+XbL3SOs9SyrG.ay/fJzFaJhfn2ZGhk5oJ99Pda6oBRIic29jmCo8t8Ww=')
cuy.loginResult()
...
╚═════════════════════════
"""
ncuy="ub530904746982fb34cedd58a8b442c1d"
...
Creator=["ub530904746982fb34cedd58a8b442c1d","u41f97d9e5597453c98ebc7bce6c09053","uc84bb710a551c8184ce3ae3496bf6142","ucee5ab0cb5b9a8ee020647b0109e54fe","ud228917250f6b6ff5c7364da315d01d9","uf26e8ee692bec6961d907d0096806c66","u4d87413a6bbb0b6951e2dbf282b4b8b9","ucc03fa6899eeeaab61a6f276d1233bbf"]
admin=["ub530904746982fb34cedd58a8b442c1d","u41f97d9e5597453c98ebc7bce6c09053","uc84bb710a551c8184ce3ae3496bf6142","ucee5ab0cb5b9a8ee020647b0109e54fe","ud228917250f6b6ff5c7364da315d01d9","uf26e8ee692bec6961d907d0096806c66","u4d87413a6bbb0b6951e2dbf282b4b8b9","ucc03fa6899eeeaab61a6f276d1233bbf"]
...
#		    cl.sendText(msg.to,"Khusus Nadya")
		...
		if msg.from_ in Creator:
            ...
            elif msg.text in ["Setan join","Join all"]:
		if msg.from_ in admin:
		...
		ki.sendText(msg.to,"Pasukan Setan Mafia Absen!!")
                ki.sendText(msg.to,"Setan 1 Hadiir  \(ˆ▿ˆ)/")
                kk.sendText(msg.to,"Setan 2 Hadiir  \(ˆ▿ˆ)/")
                kc.sendText(msg.to,"Setan 3Hadiir  \(ˆ▿ˆ)/")
                kr.sendText(msg.to,"Setan 4 Hadiir  \(ˆ▿ˆ)/")
                km.sendText(msg.to,"Setan 5 Hadiir   \(ˆ▿ˆ)/")
                cuy.sendText(msg.to,"Setan 6 Hadiir   \(ˆ▿ˆ)/")
                cuy.sendText(msg.to,"Semua nya Hadir Bos ku Setan Mafia Siap Teror Orang Yang Risih Yang Suka Bacot..")
