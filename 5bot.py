...
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token='EuOA9sDYBinaNbluGhU8.oJ0Q/i8re80a55npHIR2Ia.ZqqqeZHEvSQ9KoNNgBtaIvktfOODztnVHqWjQKl8xFg=')
cl.loginResult()
print "Cl-Login Success\n"

ki = LINETCR.LINE()
#ki.login(qr=True)
ki.login(token='EuUqGRrscN9nWVTbbENe.6lV8r5uMsjJX8da9htgrRG.w7gHsrqUnU+7L7sMubikb97Jjuqud2ahvXE0qijHcsA=')
ki.loginResult()
print "Ki-Login Success\n"

kk = LINETCR.LINE()
#kk.login(qr=True)
kk.login(token='Eu2vFHYth4SYOYtLALj6.2PrmHp8c+bFOHFXnPufADG.1XYI+WT5GcYVek6VG9xd5vdZKnMTCTE2f15fDQYqYAY=')
kk.loginResult()
print "Kk-Login Success\n"

kc = LINETCR.LINE()
#kc.login(qr=True)
kc.login(token='EuH9FzcGTIka9aS3Jth2.8h3zchDqkkKYbQyoakPUyG.G/wG8o1UzDArzyl/MI57WkPPZhH5DXEmGiV1xTAmdYw=')
kc.loginResult()
print "Kc-Login Success\n"

kr = LINETCR.LINE()
#kr.login(qr=True)
kr.login(token='Eu4bM3aFx77y7p1qoB56.mQNSHVdhd+XbL3SOs9SyrG.ay/fJzFaJhfn2ZGhk5oJ99Pda6oBRIic29jmCo8t8Ww=')
kr.loginResult()
print "Kr-Login Success\n"

adanncuy = LINETCR.LINE() #(isi dengan akun utama fungsinya biar akun utama di kick langsung di invite bot)
...
#km.login(qr=True)
km.login(token='Eu8olHLjJWwfgw1KHQ31.PyjGTnkCa60yyX44bNGlGq.ZhBrVjOEDQFCAXHyadSdxfuEZ83owT27FocHjzotH6A=')
km.loginResult()
...
┣🇮🇩━⏩KEY GROUP🇮🇩━⏩
╰━━━━━━━━━━━━━━━╯"""
ar="u3a3d2af88f1113cd00e7934f862af688"
...
RATA NGGA RATA YANG PENTING RUSUH
              TANGKIS GOBLOK
━━━━━━━━━━━━━━━━━━━━━━━━━━━━
           ━━━━━━━━━━━━━━━━━
			╔══╗╔═╗╔══╗╔═╦═╗
...
KAC=[cl,ki,kk,kc,kr,km,adanncuy]
...
Fmid = adanncuy.getProfile().mid
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,"u65224f4e8812136f01b25275a54b5aef","uc3384e476e108343bce92fc767ec3a24","u3dfecc2c1680a7d6195554f0b62806ca","u554e64f1068a515827ded0dead96741f","uebcea2e2cf1cbc241ce2eddfb9a071ac","u3a3d2af88f1113cd00e7934f862af688","ub6ef85135e48d01880ad19511538ee00"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : adanncuy\nContact Me : ⏩ line.me/ti/p/~adanncuy ⏪",
    "comment2":"Auto Like ©By : adanncuy\nContact Me : ⏩ line.me/ti/p/~adanncuy ⏪",
    "comment3":"Auto Like ©By : adanncuy\nContact Me : ⏩ line.me/ti/p/~adanncuy ⏪",
    "comment4":"Auto Like ©By : adanncuy\nContact Me : ⏩ line.me/ti/p/~adanncuy ⏪",
    "comment5":"Auto Like ©By : adanncuy\nContact Me : ⏩ line.me/ti/p/~adanncuy ⏪",
    "commentOn":True,
    "commentBlack":{},
    "message":"Thx For Add Me (^_^)\nAdd me to my channel\nline.me/ti/p/~adanncuy ⏪",
    "blacklist":{},
    "wblacklist":False,
    "dblacklist":False,
    "Qr":{},
    ...
    try:
	 ...
	 if wait["Ghost"] == True:
		...
		cl.sendText(msg.to,"Itu Owner Saya (^_^)")
                ...
                msg.contentType = 13
                admin1 = "u3a3d2af88f1113cd00e7934f862af688"
		...
		cl.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            elif msg.text in ["hacking","Hacking","hacking"]:
                cl.sendText(msg.to,hackingMessage)                 
                adanncuy.sendText(msg.to, "Teroris Berdasi")
...
#		else:                    
		...
		if wait["Simi"] == True: md+="┃🇮🇩┃✔️ Simisimi : On\n"
            ...
            elif msg.text in ["Bot1 gift","adanncuy1 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["Bot2 gift","adanncuy2 gift"]:
                msg.contentType = 9
            ...
            elif msg.text in ["Bot3 gift","adanncuy3 gift"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'ae3d9165-fab2-4e70-859b-c14a9d4137c4',
                                    'PRDTYPE': 'THEME',
                                    'MSGTPL': '8'}
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "u3a3d2af88f1113cd00e7934f862af688"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])
		...
		if msg.from_ in Creator:
            ...
            elif msg.text.lower() in ["bot","adanncuy"]:
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                ...
                cl.sendMessage(msg)
                   ...
                   print "[COPY] Ok"
                   _name = msg.text.replace("adanncuy4 copy @","")
                   _nametarget = _name.rstrip('  ')
                   gs = kr.getGroup(msg.to)
                   targets = []
                   for g in gs.members:
                ...
                try:
                    ...
                    adanncuy = text1[0].replace("s150x150/","")
                    user = "Name: " + text[-2] + "\n"
                    ...
                    cl.sendImageWithURL(msg.to, adanncuy)
            ...
            elif "/adanncuy" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/adanncuy","adanncuy")
            ...
            elif "/adanncuy1" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/adanncuy1","adanncuy1")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/adanncuy2" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/adanncuy2","adanncuy2")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/adanncuy3" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/adanncuy3","adanncuy3")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/adanncuy4" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/adanncuy4","adanncuy4")
                    if len(string.decode('utf-8')) <= 5000:
                        profile = cl.getProfile()
                        profile.displayName = string
                        kr.updateProfile(profile)
              ...
              if msg.from_ in Creator:
            ...
            elif msg.text in ["Teroris Berdasi"]:
                msg.contentType = 13
                bajingan = "udefd75736ced80dc8fca8966d246ac6f"
                bajingan2 = "u959231880d4f63db97ad90f41859b5b4"
                bajingan3 = "ucd1bf4681a9310045c6b6fce00b18172"
                bajingan4 = "u702e1287d9166485864d4cd3abda3e59"
                bajingan5 = "ua99f3c139ab0b25918184bb047403003"
                bajingan6 = "u4ac89e2857f399253290ad9d3b751554"
                bajingan7 = "u5d7fcdd055a6de2a6fd5735779235646"
                bajingan8 = "u581f341f978151394fb5e1e505ab9851"
                bajingan9 = "u90b96d89ce8813efbd11c548a5b6fa3c"
                bajingan0 = "u8bc856497159637e0dcb8450fa06e8bd"
                bajingan1 = "ue8683bf4a314bcf0b35c15194d587ca9"
                bajingan2 = "uf20915cdf94ddfcfca65328ae9ecf32f"
                bajingan3 = "u581d09157fc47e15ece9796a765080e8"
                bajingan4 = "u8cf3c7c7aba529dab47755b0e7375251"
                bajingan5 = "u8770ecbc6635e4837595eadcb5a9c9c2"
                bajingan6 = "u4b3fda5c4db9a292fbba9a3417c836f9"
                bajingan7 = "u1ba0f8d6a4fec5edf70df951190aef64"
                bajingan8 = "ufcd3e0fb51c4a7e9c5ccfb4087b0ba5e"
                bajingan9 = "u8a25013e3d9d9e3c4091dd03d3e6cff4"
                bajingan20 = "u904a026b6ebe344ff4fdd72ca2b87dc5"
                bajingan21 = "u52b0a26c865f3e71204a6fb6533bc06c"
                bajingan22 = "uf44f06815769534c4fed2a905f0d527e"
                bajingan23 = "ua23886c9dea0a603bde1f8b74622305f"
                bajingan24 = "ue28d2f1e6447e85638ed5ae9f03f1c12"
                bajingan25 = "u58443b7393aedc0dae4d4e0676450da4"
                bajingan26 = "u5b343d9bf64c9db91b97238cb019b701"
                bajingan27 = "u20001e62816b04fc2efd27d98035dc9a"
                bajingan28 = "u619700f14e75b1130bfde4594a274533"
                bajingan29 = "u49fe734da9f8acedf2acc1faa82e65f0"
                bajingan30 = "u0837f03a621c6876df5c67d0a7386a53"
                bajingan31 = "u8ee0919fab6e7b2a4aa45eef6ecffb7b"
                msg.contentMetadata = {'mid': ar}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan2}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan3}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan4}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan5}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan6}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan7}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan8}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan9}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan0}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan1}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan2}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan3}
                ...
                msg.contentMetadata = {'mid': bajingan9}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan20}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan21}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan22}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan23}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan24}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan25}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan26}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan27}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan28}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan29}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan30}
                random.choice(KAC).sendMessage(msg)
                msg.contentMetadata = {'mid': bajingan31}
                random.choice(KAC).sendMessage(msg)
		random.choice(KAC).sendText(msg.to,"KEEP ENJOY THE GAME (^_^)")
            ...
            elif msg.text in ["adanncuy1 acc invite"]:
                if msg.from_ in admin:
                    gid = ki.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["adanncuy2 acc invite"]:
                if msg.from_ in admin:
                    gid = kk.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["adanncuy3 acc invite"]:
                if msg.from_ in admin:
                    gid = kc.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
            ...
            elif msg.text in ["adanncuy4 acc invite"]:
                if msg.from_ in admin:
